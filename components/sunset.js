...
AFRAME.registerComponent('sunset', {  
    init: function () {
        ...
        if(this.el.id == "sunlight"){
            this.el.setAttribute('animation__intensity', {property: "light.intensity", to: 0.4, dur: aDuration, loop: true, easing: "linear", dir: "alternate"});
            ...
            this.el.parentEl.setAttribute('animation__rotation', {property: "rotation", to: {x: 75, y: -25, z: 0}, dur: aDuration, loop: true, easing: "linear", dir: "alternate"});
        }
        else{
